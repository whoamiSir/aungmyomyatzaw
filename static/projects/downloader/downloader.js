if (!window.location.pathname.includes('/downloader')) {
    console.log('🛑 Not on downloader page - skipping initialization');
    // Stop execution
    throw new Error('Not on downloader page');
}
...
async function handleDownload(format) {
    ...
    try {
        // ✅ FIX: Use same-origin proxy route instead of direct API call
        const response = await fetch('/api/download', {
            ...
            credentials: 'same-origin',  // ✅ Firefox fix
